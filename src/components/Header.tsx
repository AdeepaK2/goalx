      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8">
        <div className="flex justify-between items-center h-20">
          ...
          <div className="hidden md:flex items-center space-x-8">
            <Link href="/" className="text-gray-700 hover:text-[#1e0fbf] font-medium transition-colors duration-300">
              Home
            </Link>
            <Link href="/about" className="text-gray-700 hover:text-[#1e0fbf] font-medium transition-colors duration-300">
              About
            </Link>
            <Link href="/how-it-works" className="text-gray-700 hover:text-[#1e0fbf] font-medium transition-colors duration-300">
              How It Works
            </Link>
            <Link href="/contact" className="text-gray-700 hover:text-[#1e0fbf] font-medium transition-colors duration-300">
              Contact
            </Link>
          </div>
      ...
      {isMenuOpen && (
        <div className="md:hidden bg-white border-t border-gray-200">
          <div className="px-2 pt-2 pb-3 space-y-1">
            <Link href="/" className="block px-3 py-2 text-base font-medium text-gray-700 hover:text-[#1e0fbf] hover:bg-gray-50 rounded-md transition-colors duration-300">
              Home
            </Link>
            <Link href="/about" className="block px-3 py-2 text-base font-medium text-gray-700 hover:text-[#1e0fbf] hover:bg-gray-50 rounded-md transition-colors duration-300">
              About
            </Link>
            <Link href="/how-it-works" className="block px-3 py-2 text-base font-medium text-gray-700 hover:text-[#1e0fbf] hover:bg-gray-50 rounded-md transition-colors duration-300">
              How It Works
            </Link>
