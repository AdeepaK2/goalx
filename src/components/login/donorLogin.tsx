      ...
      <div style={styles.card}>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div style={styles.links}>
            <a href="/donor/register" style={styles.link}>Create an account</a>
            <a href="/donor/forgot-password" style={styles.link}>Forgot password?</a>
          </div>
        </form>
      </div>
    </div>
...
const styles: {[key: string]: React.CSSProperties} = {
  ...
  title: {
    ...
    fontWeight: '600',
    marginBottom: '24px',
    color: '#6e11b0',  // Slightly different color for donor vs admin
    textAlign: 'center',
  },
  inputGroup: {
    marginBottom: '20px',
