        ...
        <table className="min-w-full bg-white border border-gray-200">
          <thead>
            <tr className="bg-gray-50">
              ...
              <th className="py-3 px-4 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Schools Managed</th>
          ...
          <tbody className="divide-y divide-gray-200">
            <tr className="hover:bg-gray-50">
              <td className="py-4 px-4 text-sm font-medium text-gray-900">Delhi Education Society</td>
              <td className="py-4 px-4 text-sm text-gray-500">NGO</td>
              <td className="py-4 px-4 text-sm text-gray-500">12</td>
            ...
            <tr className="hover:bg-gray-50">
              <td className="py-4 px-4 text-sm font-medium text-gray-900">State Education Board</td>
              <td className="py-4 px-4 text-sm text-gray-500">Government</td>
              <td className="py-4 px-4 text-sm text-gray-500">45</td>
              <td className="py-4 px-4 text-sm">
                <span className="px-2 py-1 text-xs font-semibold rounded-full bg-green-100 text-green-800">Active</span>
              </td>
              <td className="py-4 px-4 text-sm text-[#1e0fbf] font-medium">
