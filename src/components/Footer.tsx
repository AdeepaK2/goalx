        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-1">
            <div className="flex items-center mb-4">
              ...
              <span className="ml-3 text-xl font-bold text-gray-800">GoalX</span>
            </div>
            <p className="text-gray-600 mb-4">
              Making sports equipment accessible to all schools.
            </p>
          </div>
          ...
          <div className="col-span-1">
            ...
            <div className="flex space-x-4">
              {/* YouTube */}
              <a href="#" className="text-gray-500 hover:text-[#1e0fbf] transition-colors duration-300">
            ...
            <div className="flex flex-col">
              <div className="flex items-center mb-3">
                <div className="w-8 h-8 rounded-full">
                  <img src="/logo.png" alt="GoalX logo" />
                </div>
                <span className="ml-2 text-sm font-medium text-gray-700">Powered by</span>
              </div>
              
              <div className="border border-gray-300 rounded p-3 mb-4 bg-white">
                <p className="text-sm text-gray-600">
                  {/* Sponsors name would go here */}
