...
interface EquipmentRequestHelpModalProps {
  requestId: string;
  isOpen: boolean;
  onClose: () => void;
  onSuccess?: () => void;
...
const EquipmentRequestHelpModal: React.FC<EquipmentRequestHelpModalProps> = ({
  requestId,
  isOpen,
  onClose,
  onSuccess
  ...
  return (
    <div className="fixed inset-0 z-50 overflow-y-auto bg-black bg-opacity-50 flex justify-center items-start">
      <div className="bg-white rounded-lg shadow-xl w-full max-w-4xl my-8 mx-4 max-h-[90vh] overflow-y-auto">
        {/* Modal Header */}
        <div className="flex justify-between items-center px-6 py-4 border-b border-gray-200">
          <h2 className="text-xl font-semibold text-gray-800">
            {loading ? "Loading..." : request?.eventName || "Equipment Request"}
          </h2>
          <button 
            onClick={onClose}
          ...
          {loading ? (
            ...
            <div>
              ...
              <div className="border-t border-gray-200 pt-6">
                <h3 className="text-lg font-medium text-gray-800 mb-4">Offer Help</h3>
                ...
                <form onSubmit={handleSubmit}>
                  ...
                  {/* Equipment Items */}
                  <div className="mb-6">
                    <h4 className="text-sm font-medium text-gray-800 mb-3">Equipment to Provide</h4>
...
export default EquipmentRequestHelpModal;